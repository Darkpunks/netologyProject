...
АР В теории система должна быть всегда доступна, но её узлы могут отвечать не одинаково так как данные не согласованы, но доступны и устойчивые к разделению.
