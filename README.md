...
Ответ: 
[ivan@localhost ~]$ telnet stackoverflow.com 80
Trying 151.101.1.69...
...
в простонародии "редирект", стандартный код ответа HTTP, получаемый в ответ от сервера в ситуации, когда запрошенный ресурс был на постоянной основе перемещён в новое месторасположение, и указывающий на то, что текущие ссылки, использующие данный URL, должны быть обновлены.
...
Ответ: 
код 200 
дольше всех обрабатывался stackoverflow 316 ms, не считая collect который отвалился по тайм ауту
3. Какой IP адрес у вас в интернете?

Ответ: мой ip 95.220.24.101


4. Какому провайдеру принадлежит ваш IP адрес? Какой автономной системе AS? Воспользуйтесь утилитой whois

Ответ: провайдер: RU-TI-BB-20160221, 
